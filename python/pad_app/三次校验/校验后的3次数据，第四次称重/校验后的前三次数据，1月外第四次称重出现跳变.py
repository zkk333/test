...
_fat_rate=18#假设是称重数据
_fat_ratelist=[11,12,11]  #称重校验，小小差距小于2
create_time1=a.create_time_make(33)#称重前10天
create_time2=a.create_time_make(32)#称重前9天
create_time3=a.create_time_make(31)#最新一次称重
