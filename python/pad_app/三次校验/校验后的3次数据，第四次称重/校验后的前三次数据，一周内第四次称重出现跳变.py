...
_fat_rate=8 #假设是称重数据
_fat_ratelist=[9,11,12]  #称重校验，小小差距小于2
create_time1=a.create_time_make(3)#称重前9天
create_time2=a.create_time_make(2)#称重前8天
create_time3=a.create_time_make(1)#最新一次称重一周内临界值
